...
const MENU_ITEMS_DEFAULT = {
    insertColumnRight: {
        ...
        handler() {
            ...
            console.log(this.columnToolCell);
...
export default class TableOperationMenu {
    constructor(params, quill, options) {
        ...
        this.colorSubTitle =
            options.color && options.color.text ? options.color.text : DEFAULT_COLOR_SUBTITLE;
        this.cellColors =
            options.color && options.color.colors ? options.color.colors : DEFAULT_CELL_COLORS;
